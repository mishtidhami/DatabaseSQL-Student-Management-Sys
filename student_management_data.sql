...
INSERT INTO `osad_student` (`id`, `acd_session_id`, `app_sno`, `name_en`, `name_bn`, `father_name`, `mother_name`, `gardian_name`, `nationality`, `technology`, `ff_son`, `upjati`, `sex`, `religion`, `blood_group`, `pr_address`, `phone`, `email`, `password`, `class_id`, `section_id`, `parent_id`, `roll`, `transport_id`, `dormitory_id`, `dormitory_room_number`, `pay_no`, `pay_date`, `app_date`, `photo`, `pay_status`, `cur_address`) VALUES
...
INSERT INTO `student` (`student_id`, `name`, `sex`, `religion`, `blood_group`, `address`, `phone`, `email`, `password`, `father_name`, `mother_name`, `class_id`, `section_id`, `parent_id`, `roll`, `transport_id`, `dormitory_id`, `dormitory_room_number`) VALUES
...
INSERT INTO `teacher` (`teacher_id`, `name`, `sex`, `religion`, `blood_group`, `address`, `phone`, `email`, `password`) VALUES
